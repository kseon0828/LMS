...
public class InquireDao {
    ...
    public int insertInquire(PostInquireReq postInquireReq) {
        ...
        String insertInquireQuery = "INSERT into inquiry(userEmail, title, content) VALUES(?, ?, ?)";
        Object[] insertInquireParams = new Object[]{postInquireReq.getUserEmail(), postInquireReq.getTitle(), postInquireReq.getContent()};
